    ...
    pdf.addPage(
      pw.MultiPage(
        build: (pw.Context context) => [
          ...
          pw.Text('Ο/Η υπογράφων/ουσα δηλώνω ότι:', style: pw.TextStyle(fontSize: 12)),
          ...
          pw.SizedBox(height: 8),
          pw.Text('PHOTOBIOLOGY LAB Ε.Ε.', style: pw.TextStyle(fontSize: 12)),
          pw.Text('ΙΑΤΡΙΚΗ ΕΤΕΡΟΡΡΥΘΜΗ ΕΤΑΙΡΕΙΑ', style: pw.TextStyle(fontSize: 12)),
          pw.Text('ΔΕΡΜΑΤΟΛΟΓΙΚΟ ΙΑΤΡΕΙΟ', style: pw.TextStyle(fontSize: 12)),
          pw.Text('28ΗΣ ΟΚΤΩΒΡΙΟΥ 25, ΙΩΑΝΝΙΝΑ ΤΗΛ. 2651038040', style: pw.TextStyle(fontSize: 12)),
          pw.Text('ΑΦΜ 800534270', style: pw.TextStyle(fontSize: 12)),
          pw.SizedBox(height: 8),
          pw.Text(
          ...
          pw.Text(
              ...
              style: pw.TextStyle(fontSize: 12)),
          pw.SizedBox(height: 16),
          pw.Text('Στοιχεία Ασθενούς', style: pw.TextStyle(fontSize: 14)),
          pw.Text('Όνοματεπώνυμο Ασθενούς: $name', style: pw.TextStyle(fontSize: 12)),
          pw.Text('Πατρώνυμο: $patronymic', style: pw.TextStyle(fontSize: 12)),
          pw.Text('Ημερομηνία: $date', style: pw.TextStyle(fontSize: 12)),
          pw.SizedBox(height: 16),
          pw.Text('Υπογραφή Ασθενούς:', style: pw.TextStyle(fontSize: 12)),
